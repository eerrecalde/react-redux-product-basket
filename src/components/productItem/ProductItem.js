...
const ProductList = ({item, onAddItem, qty, saving, onChange}) => (
  <li className="prod mdl-list__item mdl-list__item--custom mdl-list__item--two-line">
    <span className="mdl-list__item-primary-content">
      ...
      <span>{item.name} <span dangerouslySetInnerHTML={{__html: !item.discount || '<small>(discounted)</small>'}}></span></span>
    ...
    <span className="mdl-list__item-secondary-content mdl-list__item-secondary-content--custom">
      <div className="clearfix">
        ...
        <button disabled={saving} onClick={() => onAddItem(item.id, qty)} className="prod__button mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab mdl-button--colored">
